...
# See https://coderzcolumn.com/tutorials/data-science/gantt-chart-using-matplotlib


def GanttChart3(**kwargs):
    OutputDir = kwargs['OutputDir'] if 'OutputDir' in kwargs else 'OutputMonitor'
    Title = kwargs['Title'] if 'Title' in kwargs else 'GanttChart3'
