...
def DemoDistUniform():
    ...
    for a in alist:
        for b in blist:
            distlist = []
            for ctx in ctxlist:
                distlist.append(ctx.dist_uniform(a, b));
            Title = 'dist=uniform, a=' + str(a) + ', b=' + str(b)
            xlist = [1,2,3]
            xlist = [1]
...
def DemoPlotDistUniform():
    ...
    for j in range(len(a)):
        dlist.append(dreal.dist_uniform(a[j], b[j]))
