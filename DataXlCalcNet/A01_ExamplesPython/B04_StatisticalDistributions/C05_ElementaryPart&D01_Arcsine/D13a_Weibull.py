...
def DemoDistWeibull():
    ...
    for a in alist:
        for b in blist:
            distlist = []
            for ctx in ctxlist:
                distlist.append(ctx.dist_weibull(a, b));
            Title = 'dist=weibull, a=' + str(a) + ', b=' + str(b)
            xlist = [1,2,3]
            xlist = [1]
...
def DemoPlotDistWeibull():
    ...
    for j in range(len(a)):
        dlist.append(dreal.dist_weibull(a[j], b[j]))
