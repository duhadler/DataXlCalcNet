...
def CtxHessianRosenthal(x, hessian):
    ...
    hessian[1, 1] = 200 + Zero # + Zero is needed to ensure type conversion
...
def DemoNewtonDescentSolver():
    ...
    for Ctx in boost_list:
        ...
        matRes = Ctx.NewtonDescentSolver(Ctx.cb1VRet1S(CtxNormRosenthal), \
        Ctx.cb2V(CtxGradRosenthal), Ctx.cb1V1M(CtxHessianRosenthal), InitialState);
        fx0 = matRes[0]
        fx1 = matRes[1]
