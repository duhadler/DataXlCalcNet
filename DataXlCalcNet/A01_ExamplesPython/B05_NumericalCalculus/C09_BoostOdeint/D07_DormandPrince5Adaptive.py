...
def DemoDormandPrince5AdaptiveCtx():
    ...
    for Ctx in boost_list:
        ...
        Ctx.DormandPrince5Adaptive(Ctx.cb1S2V(FmatLorenz),  \
            Ctx.cb1S1V(FmatLorenzObserve), InitialVec, StartTime, EndTime,  \
            dt, epsabs, epsrel)
