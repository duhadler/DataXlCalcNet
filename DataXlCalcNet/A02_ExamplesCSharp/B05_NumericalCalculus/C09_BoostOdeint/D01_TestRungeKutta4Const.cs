...
/* No syntax highlighting if UsingMpfr is undefined */
    ArbPrec.SetDps(40);
#endif
    DemoRungeKutta4Const_1();
}


#region DemoRungeKutta4Const_1
...
public static void DemoRungeKutta4Const_1()
{
    Console.WriteLine();
    Console.WriteLine("DemoRungeKutta4Const: " + Ctx.name);
    var StartTime = Ctx.t(0.0);
    var EndTime = Ctx.t(1.01);
    var dt = Ctx.t(0.01);
    var InitialVec = Ctx.VecParams(10.0, 10.0, 10.0);
    Ctx.RungeKutta4Const(FmatLorenz, FmatLorenzObserve, InitialVec, StartTime, 
        EndTime, dt);
}
